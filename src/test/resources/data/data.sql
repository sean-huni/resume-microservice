...
VALUES (10, (SELECT max(id)
             FROM dr_schema.quest_ans),
        'Proving the possibility of Free Calling. The aim of this experiment is
...
INSERT INTO dr_schema.experience (id, dt_start, dt_end, desig, natow, CURRP, version, DT_CREATED, DT_UPDATED)
VALUES (6, STR_TO_DATE('01-03-2015', '%d-%m-%Y'), STR_TO_DATE('30-06-2015', '%d-%m-%Y'), 'Java Software Developer',
        'Responsibilities: ', FALSE, 1, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
...
as Fraud Detection, Decision-Support Systems, Recommendations, Vision, Image & Handwriting/Text Recognition.', 1,
        current_timestamp(), current_timestamp());
...
INSERT INTO dr_schema.education (id, DT_START, DT_END, INST, QUAL, HIGHS, O_GRADE, CURRQ, VERSION, DT_CREATED,
                                 DT_UPDATED)
VALUES (3, STR_TO_DATE('03-10-2013', '%d-%m-%Y'), STR_TO_DATE('22-07-2016', '%d-%m-%Y'), 'University of Liverpool',
...
INSERT INTO dr_schema.education (id, DT_START, DT_END, INST, QUAL, HIGHS, O_GRADE, CURRQ, VERSION, DT_CREATED,
                                 DT_UPDATED)
VALUES (5, STR_TO_DATE('01-02-2012', '%d-%m-%Y'), STR_TO_DATE('16-11-2013', '%d-%m-%Y'), 'Heriot-Watt University',
